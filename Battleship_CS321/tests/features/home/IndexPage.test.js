...
import ConnectedDefaultPage, { IndexPage } from 'src/features/home/IndexPage';
...
describe('features/home/DefaultPage', () => {
  it('redux connect works', () => {
    ...
    expect(
      wrapper.find('.home-index-page').length
    ).to.equal(1);
  });
  ...
  it('should render node with correct class name', () => {
    ...
    expect(
      renderedComponent.find('.home-index-page').getElement()
    ).to.exist;
  });
